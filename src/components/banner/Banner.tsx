...
function Banner() {
  ...
  return (
    <div className="flex flex-col items-center justify-between lg:text-[5rem] text-[2.5rem] max-sm:gap-10 text-white px-4 py-6 overflow-x-hidden max-sm:relative lg:pt-[132px]">
      ...
      <div className="flex flex-col items-center justify-center z-10 gap-4 lg:pt-[91px] max-w-140 overflow-visible">
        ...
        <div
          className="w-[500px] lg:w-[900px] absolute z-0"
          style={{
